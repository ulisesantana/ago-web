...
module.exports = [
  {
    ...
    link: '/assets/animation/dia-de-la-mujer.mp4',
    thumbnail: '/assets/animation/dia-de-la-mujer-thumbnail.png'
  }, {
    ...
    type: AnimationPlayType.video,
    thumbnail: '/assets/animation/win-city-thumbnail.png',
    link: '/assets/animation/win-city.mp4'
  }
]
